...
import SingIn from "../assets/icons/sign-in.png";
...
function HowItWorks() {
  ...
  const handleScroll = (id, index) => {
    const container = document.getElementById("howitworks-scroll-container");
      ...
      <div className="mt-5 sm:mt-12 flex relative">
        ...
        >
          <StepInfoContent
            ...
            subheading="Add the extension to your browser to enable instant saving while
            browsing."
          />
          <StepInfoContent
            id="content-box-2"
          ...
          <StepInfoContent
            ...
            heading="Search, Filter & Use Anytime"
